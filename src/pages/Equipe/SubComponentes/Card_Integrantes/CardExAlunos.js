...
function CardExAluno({ nome, srcFoto, tipo, linkedin }) {
  ...
  return (
    <div className={styles.card}>
      <div className={styles.imgContainer} onMouseEnter={() => setBlur(withBlur)} onMouseLeave={() => setBlur(noBlur)}>
        <img style={linkedin !== "" ? blurred : {}} className={styles.img} src={srcFoto} alt={altFoto} />
